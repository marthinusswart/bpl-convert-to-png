...
"$VENV_PYTHON" amiga_reader.py --generate_png bpl/pacman_tiles_mask --palette bpl/pacman_tiles.pal --output converted --no-interleaved --width 320 --height 320 --bits 1 --scale 3 --sprite_width 16 --sprite_height 16
"$VENV_PYTHON" amiga_reader.py --generate_png bpl/alphanumeric --palette bpl/pacman_tiles.pal --output converted --no-interleaved --width 160 --height 160 --scale 4 --sprite_width 8 --sprite_height 8
